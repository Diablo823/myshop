          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed">
                ...
                U.S. customers, <strong>"US" as in "we"</strong>, or even a fun
        ...
        <section>
          ...
          <div className="mt-6 text-lg leading-relaxed">
            <p className="mb-4">
              ...
              <strong>fashion and beauty</strong> brand that delivers quality
              products at affordable prices.
            </p>
            <p>
              For now, we're focusing on <strong>beauty and fashion</strong>,
              selling{" "}
              <strong>face creams, face washes, shampoos, toothpaste</strong>,
        ...
        <section>
          ...
          <div className="text-lg leading-relaxed bg-gray-50 p-6 rounded-lg">
            <p className="mb-4">
              ...
              <strong>luxury brand</strong>, delivering <strong>premium</strong>{" "}
              fashion and skincare while staying true to our core values:{" "}
